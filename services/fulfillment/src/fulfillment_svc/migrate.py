"""One-shot migration job (compose: fulfillment-migrate). Runs before any API replica starts."""
...
class MigrationSettings(ServiceSettings):
    ...
    otel_service_name: str = "fulfillment-migrate"
    database_url: str
...
def main() -> None:
    ...
    print("fulfillment-svc: migrations applied", file=sys.stderr)
