"""One-shot migration job (compose: commerce-migrate). Runs before any API replica starts."""
...
class MigrationSettings(ServiceSettings):
    ...
    otel_service_name: str = "commerce-migrate"
    database_url: str
...
def main() -> None:
    ...
    print("commerce-svc: migrations applied", file=sys.stderr)
